...
export const Header: React.FC<SearchBarProps> = ({ onSearch }) => {
    return (
        <header className="relative w-full h-1/3 ludus-bg text-white py-6 overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-8">
                <div className="z-10 flex items-center">
                    <a href="/">
                        <img className="h-10 w-auto" src="https://res.cloudinary.com/dgxkfjsbz/image/upload/v1708344010/logo_ludus_w0a3fg.png" alt="Logo" />
                    </a>
                </div>
            </div>
            <div className="flex flex-col items-center w-full z-10">
                <h1 className="sm:text-xl md:text-2xl font-forum lg:text-3xl font-bold mb-4 mt-4">PREPARE YOUR COCKTAIL</h1>
            </div>
